...
exports.create = function(req, res) {
  ...
  post.save(_.pick(req.body, 'title', 'edad' ,'Hemb','animo','colonia','contacto','masinfo','imagen','estado')).then(function() {
    res.redirect('/posts');
  },
  function() {
...
exports.update = function(req, res) {
  ...
  post.save(_.pick(req.body, 'title', 'edad' ,'vacunas','animo','colonia','contacto','masinfo')).then(function() {
